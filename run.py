...
if __name__ == "__main__": 
    ...
    config = {
        'env_id':tune.grid_search(['FetchSlide-v2']),
        ...
        'eval_every':tune.grid_search([20]),
        'num_timesteps':tune.grid_search([1_000_000]),
        'freq':tune.grid_search([3,5,10]),
        'seed':tune.grid_search(list(range(4))),
        'val_history': tune.grid_search([3]),
        'save_every':5000
    }
